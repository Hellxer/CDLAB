...
for (i = 0; i < last_index; i++)
{
if(strcmp(&dfa_states[i + 1].states,"ABCEH")==0)
	 		printf("A\t");
	else if(strcmp(&dfa_states[i + 1].states,"BCDEGHI")==0)
			printf("B\t");
	else if(strcmp(&dfa_states[i + 1].states,"BCEFGH")==0)
			printf("C\t");
	else if(strcmp(&dfa_states[i + 1].states,"BCEFGHJ")==0)
			printf("D\t");
	else if(strcmp(&dfa_states[i + 1].states,"BCEFGHK")==0)
			printf("E\t");}
printf("\n");
...
for (i = 0; i < zz; i++) {
	...
	if(strcmp(&DFA_TABLE[i][j],"ABCEH")==0)
		printf("|A \t");
	else if(strcmp(&DFA_TABLE[i][j],"BCDEGHI")==0)
			printf("|B \t");
	else if(strcmp(&DFA_TABLE[i][j],"BCEFGH")==0)
			printf("|C \t");
	else if(strcmp(&DFA_TABLE[i][j],"BCEFGHJ")==0)
			printf("|D \t");
	else if(strcmp(&DFA_TABLE[i][j],"BCEFGHK")==0)
			printf("|E  \t");
	}
	printf("\n");
}
